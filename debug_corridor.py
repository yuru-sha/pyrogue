...
def debug_corridor_builder():
    ...
    print(
        f"Room1: id={room1.id}, center={room1.center()}, bounds=({room1.x}, {room1.y}, {room1.width}, {room1.height})"
    )
    print(
        f"Room2: id={room2.id}, center={room2.center()}, bounds=({room2.x}, {room2.y}, {room2.width}, {room2.height})"
    )
