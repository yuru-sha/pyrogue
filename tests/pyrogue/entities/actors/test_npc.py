...
class TestNPC:
    ...
    def test_npc_can_trade(self):
        ...
        no_inventory_merchant = NPC(
            ...
            disposition=NPCDisposition.FRIENDLY,
            npc_type=NPCType.MERCHANT,
            dialogue_id="no_inventory_merchant",
            inventory=None,
        )
    ...
    def test_npc_quest_management(self):
        ...
        npc = NPC(
            ...
            color=(0, 0, 255),
            disposition=NPCDisposition.FRIENDLY,
            npc_type=NPCType.PRIEST,
            dialogue_id="quest_giver",
            quest_ids=["quest_1"],
        )
