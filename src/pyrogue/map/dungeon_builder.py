"""
Dungeon building components - separate classes to break down complex generation logic.
"""
...
class RoomConnector:
    """Handles room-to-room connections with corridors."""
...
class CorridorBuilder:
    """Handles corridor creation between rooms."""
...
class StairsManager:
    """Manages stair placement in the dungeon."""
    ...
    def place_stairs(self) -> None:
        ...
        # Place down stairs in last connected room
    ...
    def _place_down_stairs(self) -> None:
        """Place down stairs in the last connected room."""
