...
MONSTER_STATS: dict[
    ...
    # A-Z順でオリジナルRogueに忠実に実装
    "AQUATOR": ("A", "Aquator", 4, 15, 9, 3, 8, 6, (0, 150, 255)),  # 水棲モンスター
    "BAT": ("B", "Bat", 1, 4, 5, 1, 2, 8, (150, 150, 150)),  # 視界は広いが弱い
    "CENTAUR": ("C", "Centaur", 6, 18, 12, 4, 12, 7, (160, 82, 45)),  # 移動が速い
    "DRAGON": ("D", "Dragon", 13, 40, 20, 8, 25, 10, (255, 0, 0)),  # 最強クラス
    "EMU": ("E", "Emu", 2, 8, 7, 2, 5, 5, (139, 69, 19)),  # 鳥類、移動が速い
    "VENUS_FLYTRAP": ("F", "Venus Flytrap", 5, 20, 8, 6, 10, 2, (0, 255, 0)),  # 植物、移動しない
    "GRIFFIN": ("G", "Griffin", 8, 25, 14, 5, 15, 8, (255, 215, 0)),  # 飛行モンスター
    "HOBGOBLIN": ("H", "Hobgoblin", 7, 15, 11, 5, 10, 6, (200, 100, 0)),  # バランス型
    "ICE_MONSTER": ("I", "Ice Monster", 3, 12, 8, 3, 6, 5, (173, 216, 230)),  # 氷属性
    "JABBERWOCK": ("J", "Jabberwock", 15, 45, 22, 10, 30, 9, (138, 43, 226)),  # 最強級
    "KESTREL": ("K", "Kestrel", 2, 6, 6, 1, 4, 9, (139, 69, 19)),  # 鳥類、視界が広い
    "LEPRECHAUN": ("L", "Leprechaun", 4, 10, 6, 2, 7, 6, (0, 255, 0)),  # 小妖精、金を盗む
    "MEDUSA": ("M", "Medusa", 10, 22, 15, 6, 18, 7, (128, 0, 128)),  # 石化攻撃
    "NYMPH": ("N", "Nymph", 9, 14, 12, 4, 14, 6, (255, 192, 203)),  # バランス型
    "ORC": ("O", "Orc", 5, 12, 10, 3, 8, 5, (0, 200, 0)),  # 攻撃力と防御力が高め
    "PHANTOM": ("P", "Phantom", 12, 28, 15, 9, 21, 9, (128, 128, 255)),  # 高防御
    "QUAGGA": ("Q", "Quagga", 3, 10, 7, 2, 5, 6, (139, 69, 19)),  # シマウマ系
    "RATTLESNAKE": ("R", "Rattlesnake", 1, 5, 6, 1, 3, 6, (139, 69, 19)),  # 毒蛇
    "SNAKE": ("S", "Snake", 2, 6, 7, 1, 4, 5, (0, 255, 0)),  # 攻撃力が高め
    "TROLL": ("T", "Troll", 11, 30, 16, 6, 18, 4, (200, 200, 0)),  # 高HP、高攻撃
    "UR_VILE": ("U", "Ur-Vile", 14, 35, 19, 8, 24, 8, (75, 0, 130)),  # 魔法使い
    "VAMPIRE": ("V", "Vampire", 11, 30, 16, 6, 20, 8, (200, 0, 0)),  # 全体的に高性能
    "WRAITH": ("W", "Wraith", 12, 25, 18, 5, 22, 7, (128, 128, 128)),  # 高攻撃
    "XEROC": ("X", "Xeroc", 9, 18, 13, 4, 16, 7, (255, 255, 255)),  # 模倣能力
    "YETI": ("Y", "Yeti", 8, 22, 12, 5, 14, 5, (255, 255, 255)),  # 冷気攻撃
    "ZOMBIE": ("Z", "Zombie", 6, 16, 10, 4, 11, 3, (128, 128, 128)),  # アンデッド
}
